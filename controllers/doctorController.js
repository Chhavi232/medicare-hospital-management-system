...
// Helper Functions
// convert time 12hrs to number of minutes since midnight and return AM:PM
...
// remove duplicate slot and return slot filter by time
...
export async function doctorLogin(req, res) {
  try {
    ...
    // check password (as shown in video - plain compare)
